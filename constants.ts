export default class Constants {
  ...
  public readonly throwErrorWhenUserNotFound: string =
    "should throw an error when user is not found";
  public readonly throw404WhenUserNotFound =
    "should return 404 when the user is not found";
  public readonly return200AndTokenWhenUserIsFound =
    "should return 200 and token when user is found";
  public readonly createUserAndReturnToken =
    "should create a user and return a token";
  ...
  public readonly accountAlreadyExists =
    "Account already exists, log in with email and password";
